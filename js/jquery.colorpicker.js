...
(function($) {
    ...
    $.fn.colorpicker = function(options) {
        ...
        return this.each(function(){
            ...
            obj.bind(opts.event,function(){
                $.fn.colorpicker.clickfun(obj, opts, $(this));
            });
        });
        function initColor(){
    ...
    $.fn.colorpicker.getRGBColor = function(color) {
        var result;
    ...
    $.fn.colorpicker.clickfun = function(obj, opts, objel) {
        //定位
        var ttop = objel.offset().top;     //控件的定位点高
        var thei = objel.height();  //控件本身的高
        var tleft = objel.offset().left;    //控件的定位点宽
        $("#colorpanel").css({
            top: ttop + thei + 5,
            left: tleft
        }).show();
        var target = opts.target ? $(opts.target) : obj;
        if (target && target.data("color") == null) {
            target.data("color", target.css("color"));
        }
        if (target && target.data("value") == null) {
        ...
        $("#CT tr td").unbind("click").mouseover(function () {
            ...
            color = opts.ishex ? color : $.fn.colorpicker.getRGBColor(color);
            if (target) {
